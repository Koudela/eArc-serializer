...
use eArc\SerializerExamples\ExportOrdersToCSV\Entities\OrderItem;

class OrderItemDataType extends AbstractDataType
{
    public function isResponsibleForSerialization(?object $object, $propertyName, $propertyValue): bool
    {
        return $propertyValue instanceof OrderItem;
    }
}
